...
class Faehre(object):
    ...
    def __init__(self):
        ...
        self.Hoehe=4000.0 + random.randint(-1000, 1000)
        self.Geschw=0.0
        self.Beschleunigung = self.MondBeschleunigung
        self.Tank = 5000 + random.randint(-1000, 1000)
        self.SchubFaktor = 0.04 + random.uniform(-0.02, 0.02)
...
def NochmalSpielen():
    print "Wollen Sie nocheinmal spielen? (ja, nein)"
    auswahl = raw_input()
